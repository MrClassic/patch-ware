...
${OBJECTDIR}/BiquadFilter.o: BiquadFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BiquadFilter.o BiquadFilter.cpp

${OBJECTDIR}/Compressor.o: Compressor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Compressor.o Compressor.cpp
...
${OBJECTDIR}/Distortion.o: Distortion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Distortion.o Distortion.cpp

${OBJECTDIR}/FIRFilter.o: FIRFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FIRFilter.o FIRFilter.cpp
...
${OBJECTDIR}/Gain.o: Gain.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Gain.o Gain.cpp

${OBJECTDIR}/IIRFilter.o: IIRFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IIRFilter.o IIRFilter.cpp

${OBJECTDIR}/InputDevice.o: InputDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputDevice.o InputDevice.cpp

${OBJECTDIR}/OutputDevice.o: OutputDevice.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutputDevice.o OutputDevice.cpp
...
${OBJECTDIR}/Patch.o: Patch.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Patch.o Patch.cpp

${OBJECTDIR}/QuadraticWaveGenerator.o: QuadraticWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QuadraticWaveGenerator.o QuadraticWaveGenerator.cpp

${OBJECTDIR}/SawtoothWaveGenerator.o: SawtoothWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SawtoothWaveGenerator.o SawtoothWaveGenerator.cpp

${OBJECTDIR}/SineWaveGenerator.o: SineWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SineWaveGenerator.o SineWaveGenerator.cpp

${OBJECTDIR}/SquareWaveGenerator.o: SquareWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SquareWaveGenerator.o SquareWaveGenerator.cpp

${OBJECTDIR}/TriangleWaveGenerator.o: TriangleWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TriangleWaveGenerator.o TriangleWaveGenerator.cpp

${OBJECTDIR}/ZeroWaveGenerator.o: ZeroWaveGenerator.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ZeroWaveGenerator.o ZeroWaveGenerator.cpp
...
${OBJECTDIR}/sineTable.o: sineTable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sineTable.o sineTable.cpp
